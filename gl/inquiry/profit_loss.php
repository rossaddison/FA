...
function display_type (?string $type, ?string $typename, string|int|float|bool|array|null $from, string|int|float|bool|array|FrontReport|null $to, mixed $begin, mixed $end, mixed $compare, mixed $convert,
	string|int|float|bool|array|null $dimension, string|int|float|bool|array|null $dimension2, mixed $drilldown)
{
