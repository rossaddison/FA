 ...
 */
function getTransactions(string|int|array|null $category, string|array|null $location, string|array|null $fromcust, string|null $from, string|null $to, string|array|null $show_service)
{
	$from = date2sql($from);
	$to = date2sql($to);
