 ...
 */
function getTransactions(string|int|array|null $category, string|array|null $location, string|array|null $fromsupp, string|null $item, string|array|null $from, string|null $to)
{
	$from = date2sql($from);
	$to = date2sql($to);
